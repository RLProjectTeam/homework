...
PYTHONPATH=$PWD python3 -u app/selfplay.py --model_num_epochs 3 --model_num_selfplay_epochs 3 --model_batch_size 2 --model_max_steps_per_episode 40  --model_is_self_play True --model_is_self_play_with_memory True --model_memory_type lstm_memory > log.txt
PYTHONPATH=$PWD python3 -u app/selfplay.py --model_num_epochs 3 --model_num_selfplay_epochs 3 --model_batch_size 2 --model_max_steps_per_episode 40  --model_is_self_play True --model_is_self_play_with_memory True --model_memory_type base_memory > log.txt
PYTHONPATH=$PWD python3 -u app/selfplay.py --model_num_epochs 3 --model_num_selfplay_epochs 3 --model_batch_size 2 --model_max_steps_per_episode 40 --model_is_self_play True > log.txt
